    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(null=True, unique=True, verbose_name='ISBN')),
                ('bbk', models.CharField(null=True, unique=True, verbose_name='ББК')),
                ('udk', models.CharField(null=True, unique=True, verbose_name='УДК')),
